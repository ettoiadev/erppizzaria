...
-- 5. Definir todos os entregadores existentes como ativos
DO $$
BEGIN
    UPDATE drivers 
    SET active = true 
    ...
    RAISE NOTICE 'Entregadores existentes definidos como ativos!';
END
$$;

-- 6. Verificar estrutura final da tabela drivers
SELECT 
    column_name, 
    data_type, 
    is_nullable, 
...
-- Executar este SELECT para confirmar que o script funcionou
SELECT 'Script executado com sucesso! Sistema de exclusão de entregadores melhorado.' as resultado; 