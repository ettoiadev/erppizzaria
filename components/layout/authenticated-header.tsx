            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-64 p-0 shadow-lg border-0 bg-white rounded-xl">
                <div className="px-4 py-3 bg-gradient-to-r from-blue-50 to-purple-50 rounded-t-xl border-b">
                  <p className="text-sm font-semibold text-gray-900">Olá, {getShortName(user.full_name)}! 👋</p>
                ...
                <div className="px-4 py-3 border-b bg-gray-50">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-gray-900 truncate">Olá, {getShortName(user.full_name)}</p>
