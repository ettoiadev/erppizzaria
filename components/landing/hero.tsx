    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-red-600 via-red-700 to-red-800 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="max-w-7xl mx-auto text-white">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            <div className="md:w-1/2 text-center md:text-left">
              ...
              >
                ...
                <p className="text-xl md:text-2xl mb-8 text-red-100 max-w-3xl mx-auto md:mx-0 leading-relaxed">
          ...
          {/* Features (moved below the two-column layout) */}
          <div
            className={`transition-all duration-1000 delay-500 mt-16 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            }`}
          >
