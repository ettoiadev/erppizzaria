    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Badge variant={serverRunning ? "success" : "destructive"} className="flex items-center gap-1">
            {serverRunning ? (
              <>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => setConfig({ ...config, interface: value })}
              >
                <SelectTrigger>
            ...
            {config.interface.startsWith('tcp://') && (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setConfig({ ...config, interface: `tcp://${e.target.value}` })}
                />
              </div>
            )}
